...
export default function KanbanColumn({
  ...
  return (
    <div
      ...
      className="relative flex-shrink-0 w-80 xl:w-96 2xl:w-[28rem] flex flex-col rounded-md border border-gray-200 bg-gray-50 overflow-hidden min-h-0 snap-start"
    >
      {/* Column Header */}
      <div className="sticky top-0 z-10 bg-gray-50/95 supports-[backdrop-filter]:bg-gray-50/80 backdrop-blur px-3 py-2 border-b border-gray-200 flex items-center justify-between">
                    ...
                    >
                      <div className="min-w-0">
                        ...
                        <div className="flex items-center gap-2 text-xs text-gray-500">
                          ...
                          {col && (
                            <span className="px-1.5 py-0.5 rounded bg-gray-100 border border-gray-200">{col.title}</span>
                          )}
                        </div>
                      </div>
                    </button>
